...
public class EffectManagerTest
{
    ...
    public void TestApplyEffect()
    {
        ...
        _entity.EventBus.Subscribe<IEffect>(EventBus.EventVariant.EffectApplied, e => appliedEffect = e);
    ...
    public void TestEffectExpiration()
    {
        ...
        _entity.EventBus.Subscribe<string>(EventBus.EventVariant.EffectRemoved, id =>
        {
            removedEffectId = id;
    ...
    public void TestStackingEffects()
    {
        ...
        _entity.EventBus.Subscribe<(string, int)>(EventBus.EventVariant.EffectRefreshed, data =>
        {
