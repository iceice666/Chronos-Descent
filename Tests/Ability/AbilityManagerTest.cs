...
public class AbilityManagerTest
{
    ...
    public void TestAbilityChangeEvent()
    {
        ...
        _entity.EventBus.Subscribe<AbilitySlotType>(EventBus.EventVariant.AbilityChange,
    ...
    public void TestActivateActiveAbility()
    {
        ...
        _entity.EventBus.Subscribe<BaseAbility>(EventBus.EventVariant.AbilityActivate,
    ...
    public void TestCooldownSystem()
    {
        ...
        _entity.EventBus.Subscribe<BaseAbility>(EventBus.EventVariant.AbilityCooldownFinished,
