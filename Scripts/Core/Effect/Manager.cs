...
public class Manager : IManager
{
        ...
        var effectsToRemove = _activeEffects
            .Where(pair =>
            {
                ...
                if (!pair.Value.IsExpired())
                    _owner.EventBus.Publish(EventBus.EventVariant.EffectTimerUpdated, pair.Value.RemainingDuration);
    ...
    public void ApplyEffect(IEffect effect)
    {
        ...
        if (_activeEffects.TryGetValue(effectId, out var existingEffect))
        {
            ...
            // Emit signal for UI
            _owner.EventBus.Publish(EventBus.EventVariant.EffectRefreshed, (effectId, existingEffect.CurrentStacks));
        }
        else
        {
            ...
            // Emit signal for UI
            _owner.EventBus.Publish(EventBus.EventVariant.EffectApplied, effect);
        }
    }
    ...
    public void RemoveEffect(string effectId)
    {
        ...
        // Emit signal for UI
        _owner.EventBus.Publish(EventBus.EventVariant.EffectRemoved, effectId);
    }
