...
public abstract class BaseAbility
{
    ...
    protected AbilityState State
    {
        ...
        {
            _state = value;
            Caster.EventBus.Publish(EventBus.EventVariant.AbilityStateChange, this);
        }
    }
    ...
    public double Cooldown { get; protected init; }
    ...
    protected void UpdateTimer(double delta)
    {
        ...
        {
            CurrentCooldown = 0;
            Caster.EventBus.Publish(EventBus.EventVariant.AbilityCooldownFinished, this);
        }
        else
        {
            Caster.EventBus.Publish(EventBus.EventVariant.AbilityCooldownChange, this);
        }
    }
...
{
    public double MaxChargeTime { get; protected set; }

    public bool AutoCastWhenFull { get; protected set; }

    public double MinChargeTime { get; set; }
